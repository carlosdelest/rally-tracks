...
- Search Operations:
  ...
  - `esql_data_partitioning` (default: SEGMENT) : Data partitioning to use when `esql_data_partitioning_enabled` is true. Available values: DOC, SEGMENT, SHARD, AUTO
  ...
  - `dsl_profiling_enabled` (default: false) : False to add separate profiling runs for DSL operations.
